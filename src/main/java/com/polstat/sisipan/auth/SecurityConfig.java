...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .requestMatchers(HttpMethod.POST,"/provinsi/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.PATCH,"/provinsi/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.PUT,"/provinsi/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE,"/provinsi/**").hasRole("ADMIN")
