...
public class PilihanGraphqlController {
...
//                Link selfLink = WebMvcLinkBuilder.linkTo(PilihanGraphqlController.class).slash("pilihan").slash(pilihan.getId()).withSelfRel();
//
